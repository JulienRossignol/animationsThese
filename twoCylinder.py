...
class Detector(ThreeDScene):
    ...
    def construct(self):        
        ...
        eauAnimation = AnimationGroup(*[self.GetRandomBeam([7,-0.8,0], detector2, phantomCylinder2.get_center(), [60,90,100], counter2, reference_length = 15) for _ in range(numberOfEvents)], lag_ratio = 0.4)
